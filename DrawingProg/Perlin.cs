...
//Credit to Adrian Biagioli (username Flafl2) from github. https://gist.github.com/Flafla2/1a0b9ebef678bbce3215
...
namespace DrawingProg
{
    public class Perlin
    {
        ...
        public static double perlin(double x, double y, double z, int repeat = 0)
        {
            if (repeat > 0)
